<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/List.Master" AutoEventWireup="true" CodeBehind="YZDeviceManage.aspx.cs" Inherits="YUNZHI.Management.Manage.YZDeviceManage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    <article class="page-container">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">设备SN<span class="c-red">*</span>：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <asp:TextBox ID="txtDSN" runat="server" CssClass="input-text radius txtproblem" datatype="*" nullmsg="账号不能为空"></asp:TextBox>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">状态<span class="c-red">*</span>：</label>
            <div class="formControls col-xs-8 col-sm-9">
