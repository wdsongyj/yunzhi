...
{
    public partial class YZDeviceList : System.Web.UI.Page
    {
        ...
        public void BindRepeater()
        {
            try
            {
                ...
                dt = dal.YZ_GetDeviceList("", sn, hName, status, this.pagerbind.PageSize, this.pagerbind.CurrentPageIndex, out totalcount);
        ...
        protected void lbBatchDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    sbSQL.Append("update [dbo].[YZ_Device] set IsEnable=0 where ID='" + item + "'; ");
                }
