<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/List.Master" AutoEventWireup="true" CodeBehind="YZDistrictManage.aspx.cs" Inherits="YUNZHI.Management.Manage.YZDistrictManage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
     <article class="page-container">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">区域<span class="c-red">*</span>：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <asp:TextBox ID="txtAreaName" runat="server" CssClass="input-text radius txtproblem" datatype="*" nullmsg="机构代码不能为空"></asp:TextBox>
            </div>
        </div>
        <div class="row cl">
