...
namespace Paway.Windows.Forms
{
    ...
    public class FormBase : Form
    {
        ...
        /// 系统菜单
        /// </summary>
        protected EMouseState _sysMenuState = EMouseState.Normal;
        /// <summary>
        /// 关闭按钮的鼠标状态
        /// </summary>
        ...
        private bool _isShowMaxBox = false;

        private bool _isShowMinBox = false;

        private bool _isSysMenuButton = false;
        ...
        /// 是否显示
        /// </summary>
        public bool IsSysMenuButton
        {
            get { return this._isSysMenuButton; }
            set { this._isSysMenuButton = value; }
        }
        /// <summary>
        /// 是否显示
        /// </summary>
        ...
        {
            get { return this._isShowMinBox; }
            set { this._isShowMinBox = value; }
        }
        /// <summary>
        /// 是否显示
        /// </summary>
        ...
        {
            get { return this._isShowMaxBox; }
            set { this._isShowMaxBox = value; }
        }
        /// <summary>
        /// 是否允许改变窗口大小
        /// </summary>
        ...
        /// 系统菜单按钮区域
        /// </summary>
        protected virtual Rectangle SysMenuRect
        {
            get { return Rectangle.Empty; }
        }
        /// <summary>
        ...
        /// 菜单按钮
        /// </summary>
        protected EMouseState SysMenuState
        {
            get { return this._sysMenuState; }
            set
            {
                this._sysMenuState = value;
                base.Invalidate(this.SysMenuRect);
            }
        }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                else if (this.SysBtnRect.Contains(point))
                    this.SysMenuState = EMouseState.Down; 
            }
            if (this.WindowState != FormWindowState.Maximized)
            {
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            //系统菜单
            if (this.SysMenuRect.Contains(point))
